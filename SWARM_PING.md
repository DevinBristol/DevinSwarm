...
- **Smoke tests:** Local smoke run complete: `0f92821d-ad1c-4566-b31a-bf3f9a86b93d` (description: "Smoke test via CLI") completed through report. Render smokes `64addeb2-46ae-4092-ba6d-d9ed15248568` and `f36544e0-f8cb-4487-8c8a-9e8e3d532bfc` hit reviewer OOM (`npm run build`) and remain blocked even after unblock. Reviewer/ops defaults now bump heap; redeploy and rerun a Render smoke.
