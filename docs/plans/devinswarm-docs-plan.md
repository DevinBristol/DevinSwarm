...
- [x] Keep `SWARM_PING.md` and recent smoke logs current alongside runbook updates.
...
- 2025-11-21: Added orchestrator event/HITL tests, refreshed `SWARM_PING.md`, and captured new local smoke log `docs/logs/local-smoke-2025-11-21.md` (ts-node fallback noted).
- 2025-11-22: Documented ts-node runner fallback (`scripts/run-ts-node.js`) to bypass Windows esbuild/tsx spawn errors and updated status/docs accordingly.
